module.exports = {
        ...
        'obi:validation': [
            {
                ...
                'obi:validationSchema':
                    'https://w3id.org/blockcerts/schema/2.0-alpha/recipientSchema.json',
            },
            {
                'obi:validatesType': 'SignatureLine',
                'obi:validationSchema':
                    'https://w3id.org/blockcerts/schema/2.0-alpha/signatureLineSchema.json',
            },
            {
                'obi:validatesType': 'MerkleProof2017',
                'obi:validationSchema':
                    'https://w3id.org/blockcerts/schema/2.0-alpha/merkleProof2017Schema.json',
            },
        ],
    },
    blockcertsv1_2: {
        ...
        validation: [
            {
                ...
                validationSchema:
                    'https://w3id.org/blockcerts/schema/1.2/assertion-1.2.json',
            },
            {
                type: 'TypeValidation',
                validatesType: 'Certificate',
                validationSchema:
                    'https://w3id.org/blockcerts/schema/1.2/certificate-1.2.json',
            },
            {
                type: 'TypeValidation',
                validatesType: 'Issuer',
                validationSchema:
                    'https://w3id.org/blockcerts/schema/1.2/issuer-1.2.json',
            },
            {
                type: 'TypeValidation',
                validatesType: 'CertificateDocument',
                validationSchema:
                    'https://w3id.org/blockcerts/schema/1.2/certificate-document-1.2.json',
            },
            {
                type: 'TypeValidation',
                validatesType: 'BlockchainCertificate',
                validationSchema:
                    'https://w3id.org/blockcerts/schema/1.2/blockchain-certificate-1.2.json',
            },
            {
                type: 'TypeValidation',
                validatesType: 'BlockchainReceipt',
                validationSchema:
                    'https://w3id.org/blockcerts/schema/1.2/blockchain-receipt-1.2.json',
            },
        ],
    },
    blockcertsv2: {
        ...
        'obi:validation': [
            {
                'obi:validatesType': 'RecipientProfile',
                'obi:validationSchema':
                    'https://w3id.org/blockcerts/schema/2.0/recipientSchema.json',
            },
            {
                'obi:validatesType': 'SignatureLine',
                'obi:validationSchema':
                    'https://w3id.org/blockcerts/schema/2.0/signatureLineSchema.json',
            },
            {
                'obi:validatesType': 'MerkleProof2017',
                'obi:validationSchema':
                    'https://w3id.org/blockcerts/schema/2.0/merkleProof2017Schema.json',
            },
        ],
    },
    blockcertsV3: {
    ...
    merkleProof2019: {
        '@id':
            'https://w3id.org/blockcerts/schema/3.0-alpha/merkleProof2019Schema.json',
        '@context': {
            '@version': 1.1,
            challenge: 'sec:challenge',
            created: {
